 ...
 * Note: param for Closure Compiler // @debug true
// ==ClosureCompiler==
...
/*  Copyright (c) 2009-2014 By Vy Ho
  9.9.22:
   - Fixed CL image issues due to CL changes
  9.9.21:
   - Improved some round corner rendering and initial layout
  9.9.20:
...
(function(){
    ...
    /** manually added just to prevent closure compiler error **/
    vyho.lib.apps = {};
    vyho.lib.ui = {};
    vyho.lib.net = {};
    vyho.lib.apps.craigslist = {};
    vyho.lib.lang = {};
    vyho.lib.pref = {};
    vyho.lib.parser = {};
    ...
    vyho.lib.apps.CraigslistFusion = function(browserWin, configs) {
        ...
        this.initialize = function(browserWin) {
            ...
            try {
                ...
                */
                ...
                this.preferenceWindow = new vyho.lib.ui.MiniWin(this.PREFERENCE_WINDOW, 500, 400, 
                    "Preferences" + sess, null, this.browserWin.document, this.browserWin, this.winManager,
                    {
                        cornerRadius: this.preferences.getRoundCornerRadius().getValue()
                        }
                    );

                //this.preferenceWindow.addSizeChangeListener(new vyho.lib.ui.WindowSizeChangeListener(this.PREFERENCE_WINDOW, browserWin, this.layout));
                //this.preferenceWindow.addSizeChangeListener(new vyho.lib.ui.WindowSizeChangeListener(this.PREFERENCE_WINDOW, browserWin, this.layout));
                ...
                this.favWindow = new vyho.lib.ui.MiniWin(this.FAV_WINDOW, 500, 400, "Favorites" + sess,
                    null, this.browserWin.document, this.browserWin, this.winManager,
                    {
                        cornerRadius: this.preferences.getRoundCornerRadius().getValue()
                        });
                this.favWindow.addClosingListener(new vyho.lib.ui.WindowClosingListener(this.FAV_WINDOW));
                //this.favWindow.addSizeChangeListener(new vyho.lib.ui.WindowSizeChangeListener(this.FAV_WINDOW, browserWin, this.layout));
                ...
                this.bookmarkWindow = new vyho.lib.ui.MiniWin(this.BOOKMARK_WINDOW, 500, 400, "Bookmarks" + sess, 
                    null, this.browserWin.document, this.browserWin, this.winManager,
                    {
                        cornerRadius: this.preferences.getRoundCornerRadius().getValue()
                        });
                ...
                //this.bookmarkWindow.addSizeChangeListener(new vyho.lib.ui.WindowSizeChangeListener(this.BOOKMARK_WINDOW, browserWin, this.layout));
                ...
                if (this.photoWindow != null) {
                    this.photoWindow.destroy(null);
                }
                this.photoWindow = new vyho.lib.ui.MiniWin(this.PHOTO_WINDOW, 500, 400, "Photo" + sess, 
                    null, this.browserWin.document, this.browserWin, this.winManager,
                    {
                        cornerRadius: this.preferences.getRoundCornerRadius().getValue()
                        });

                this.imageWindowSizeChangeListener = new vyho.lib.ui.WindowSizeChangeListener(this.PHOTO_WINDOW, this.browserWin, this.layout);
                //this.photoWindow.addSizeChangeListener(this.imageWindowSizeChangeListener);
                ...
                this.photoWindow.addClosingListener(new vyho.lib.ui.WindowClosingListener(this.PHOTO_WINDOW,
                    vyho.lib.Utilities.runWith(this, this.onImageWindowHide, "", "")));
                //this.photoWindow.addVisibleListener(new WindowVisibleChangeListener(this, "onWindowVisibleChange"));
                //this.photoWindow.addSizeChangeListener(new vyho.lib.ui.WindowSizeChangeListener(this.PHOTO_WINDOW, browserWin, this.layout));
                this.layout.addComponent(this.photoWindow, vyho.lib.ui.DockLayout.RIGHT);

                this.photoWindow.setMinimizeTitle(minimizeTitle);
                this.photoWindow.setActiveBorderColor(activeWindowBorderColor);
                this.photoWindow.setInactiveBorderColor(inactiveWindowBorderColor);
                /*
                ...
                if (this.detailsWindow != null) {
                    this.detailsWindow.destroy(null);
                }
                this.detailsWindow = new vyho.lib.ui.MiniWin(this.INFO_WINDOW, 500, 400, "Details" + sess, 
                    null, this.browserWin.document, this.browserWin, this.winManager,
                    {
                        cornerRadius: this.preferences.getRoundCornerRadius().getValue()
                        });

                //            this.detailsWindow.addSizeChangeListener(new vyho.lib.ui.WindowSizeChangeListener(this.INFO_WINDOW, browserWin));
                //this.detailsWindow.addSizeChangeListener(new vyho.lib.ui.WindowSizeChangeListener(this.INFO_WINDOW, browserWin, this.layout));
                this.detailsWindow.addClosingListener(new vyho.lib.ui.WindowClosingListener(this.INFO_WINDOW, vyho.lib.Utilities.runWith(this, this.onDetailWindowHide, "", "")));
                //this.detailsWindow.addVisibleListener(new WindowVisibleChangeListener(this, "onWindowVisibleChange"));
                this.layout.addComponent(this.detailsWindow, vyho.lib.ui.DockLayout.RIGHT);

                this.detailsWindow.setMinimizeTitle(minimizeTitle);
                this.detailsWindow.setActiveBorderColor(activeWindowBorderColor);
                this.detailsWindow.setInactiveBorderColor(inactiveWindowBorderColor);
                this.detailsWindow.setBackgroundColor(this.preferences.getBackgroundColor().getValue());
                //this.detailsWindow.setInactiveBordderColor(inactiveWindowBorderColor);
                ...
                this.templateWindow = new vyho.lib.ui.MiniWin(this.TEMPLATE_WINDOW,
                    500, 400, "Email Template Manager" + sess, null, this.browserWin.document, this.browserWin, 
                    this.winManager,
                    {
                        cornerRadius: this.preferences.getRoundCornerRadius().getValue()
                        });
                ...
                //this.templateWindow.addSizeChangeListener(new vyho.lib.ui.WindowSizeChangeListener(this.TEMPLATE_WINDOW, browserWin, this.layout));
                ...
                //this.googleMap.addSizeChangeListener(new vyho.lib.ui.WindowSizeChangeListener(this.GOOGLEMAP_WINDOW, browserWin, this.layout));
                ...
                this.browserWin.addEventListener("resize", vyho.lib.Utilities.runWith(this.layout, 
                    this.layout.doLayout, null, null), true);
                ...
                this.detailsWindow.setVisible(false);
                this.preferenceWindow.setVisible(false);
                this.photoWindow.setVisible(false);
                ...
                //this.listingWin.addLayoutChangeListener(new vyho.lib.ui.WindowLayoutListener(this.LISTING_WINDOW, browserWin, this.layout));
                //this.listingWin.addSizeChangeListener(new vyho.lib.ui.WindowSizeChangeListener(this.LISTING_WINDOW, browserWin, this.layout));
                ...
                //this.searchWindow.addSizeChangeListener(new vyho.lib.ui.WindowSizeChangeListener(this.AUTOSEARCH_WINDOW, browserWin, this.layout));
                //this.searchWindow.addLayoutChangeListener(new vyho.lib.ui.WindowLayoutListener(this.AUTOSEARCH_WINDOW, browserWin, this.layout));
                ...
                var layoutArea = this.layout.getLayoutArea(browserWin);
                this.layout.prevWidth = layoutArea.width;
                this.layout.prevHeight = layoutArea.height;
        ...
        this.showBookmarks = function(browserWin, container) {
            try {
                ...
                for (var i = 0; i < 8 && i < this.bookmarkList.length; i++) {
        ...
        */
        ...
        this.hasLayoutPreferences = function() {
            var value = vyho.lib.Utilities.pref_getValue("vyho.lib.craigslistFusion.CheckLayoutPreferencesV3.2", null);
            
            if (value == null) {
                vyho.lib.Utilities.pref_setValue("vyho.lib.craigslistFusion.CheckLayoutPreferencesV3.2", 0);
                return false;
            } else {
                if (value == 0 || value == 1) {
                    value = value + 1;
                    vyho.lib.Utilities.pref_setValue("vyho.lib.craigslistFusion.CheckLayoutPreferencesV3.2", value);
                    return false;
                }
                return true;
            }
        ...
        this.setupListingWindow = function() {
            ...
            this.theForm = this.browserWin.document.getElementById("searchform");    //vyho.lib.Utilities.findFirstItem("form", null, this.browserWin.document);
            ...
            this.controlArea.style.borderRadius = this.preferences.getRoundCornerRadius().getValue();
            this.controlArea.style.overflow = "hidden";
            ...
            this.controlTitle.setAttribute("style", "width: 100%; height: 20px; background-color:rgba(200, 200, 200, 0.5); ");   //totally opaque
            
            var titleDiv = vyho.lib.Utilities.addNew("div", this.controlTitle);
            titleDiv.setAttribute("style", "width: 150px; height: 20px; background-color: #AADDDD; float: right;");
            titleDiv.style.borderRadius = this.preferences.getRoundCornerRadius().getValue();
            
            vyho.lib.Utilities.newText("Craigslist Fusion", titleDiv);

            var commandDiv = vyho.lib.Utilities.addNew("div", this.controlArea);
            this.ignoreNext = false;
            this.controlArea.addEventListener("click", vyho.lib.Utilities.runWith(this, function(evt, commandDiv, p2) {
                //NOTE: only consume event if the control title (the small band)  is shown,
                //else, dont' consume it so links work
                if (vyho.lib.Utilities.hasClass(this.controlTitle, "expandedSearchPanel") || this.ignoreNext) {
                    evt.preventDefault();
                    evt.stopPropagation();
                    //vyho.lib.Utilities.runOnce(function() {
                    this.showToolbar(evt, commandDiv, true);
                    //}, 10);
                    if (this.ignoreNext) {
                        this.ignoreNext = false;
                    } else {
            ...
            commandDiv.style.borderRadius = this.preferences.getRoundCornerRadius().getValue();
            
            var table = vyho.lib.Utilities.addNew("table", commandDiv);
            //table.style.borderRadius = this.preferences.getRoundCornerRadius().getValue();
            ...
            pref.style.borderRadius = this.preferences.getRoundCornerRadius().getValue();
            pref.setAttribute("style", cmdStyle);
            pref.href = "javascript:void(0)";
            vyho.lib.Utilities.newText("Preferences", pref);
            pref.addEventListener("click", vyho.lib.Utilities.runWith(this, this.showPreference, this.browserWin, commandDiv), false);
            ...
            fav.addEventListener("click", vyho.lib.Utilities.runWith(this, this.showFavorites, this.browserWin, commandDiv), false);
            td.style.width = "100px";
            ...
            searchLink.addEventListener("click", vyho.lib.Utilities.runWith(this, this.showFilterAndSearchWindow, 1.0, commandDiv), false);
            ...
            sticky.addEventListener("click", vyho.lib.Utilities.runWith(this, this.setStickyMode, this.browserWin, commandDiv), false);
            td.style.width = "100px";
            ...
            resizer.addEventListener("click", vyho.lib.Utilities.runWith(this, this.layoutWindows, 0.5, commandDiv), false);
            ...
            resizer.addEventListener("click", vyho.lib.Utilities.runWith(this, this.layoutWindows, 0.6, commandDiv), false);
            ...
            resizer.addEventListener("click", vyho.lib.Utilities.runWith(this, this.layoutWindows, 1.0, commandDiv), false);
            ...
            bookmark.addEventListener("click", vyho.lib.Utilities.runWith(this, this.addBookmark, false, commandDiv), false);
            ...
            goTop.addEventListener("click", vyho.lib.Utilities.runWith(this, this.gotoTop, commandDiv, null), false);
            ...
            if (this.preferences.getEnableAutoHideForm().getValue()) {
                ...
                vyho.lib.Utilities.hover(this.controlArea, null, null, null,
                    ...
                    vyho.lib.Utilities.runWith(this, function(evt, p1, p2) {
                        ...
                        this.showToolbar(evt, commandDiv, false);
                    })
                    );
            }
            
            var entryDiv = vyho.lib.Utilities.addNew("div", this.getListingArea());
            entryDiv.id = "topOfListingArea";
        ...
        this.showToolbar = function(evt, commandDiv, show) {
            if (evt) {
                evt.preventDefault();
                evt.stopPropagation();
            }
        ...
        this.gotoTop = function(evt, commandDiv) {
            if (evt) {
                evt.preventDefault();
                evt.stopPropagation();
            }
            ...
            var gotoTop = browserWin.document.getElementById("topOfListingArea");
        ...
        this.showFilterAndSearchWindow = function(evt, param1, commandDiv) {
            if (evt) {
                evt.preventDefault();
                evt.stopPropagation();
            }
        ...
        this.layoutWindows = function(evt, percent, commandDiv) {
            try {
                if (evt) {
                    evt.preventDefault();
                    evt.stopPropagation();
                ...
                var listWidth = vyho.lib.Utilities.roundInt(percent * layoutArea.width);
                var detailsWidth = layoutArea.width - listWidth;

                var topHeight = vyho.lib.Utilities.roundInt(layoutArea.height / 2);
                var bottomHeight = layoutArea.height - topHeight;
                ...
                //Set default size
                for (var i = 0; i < this.layout.components.length; i++) {
                    visible = this.layout.components[i].isVisible();
                    this.layout.components[i].setVisible(true);
                    this.layout.components[i].setBounds(layoutArea.top + layoutArea.height * 0.1, layoutArea.left + layoutArea.width * 0.10, layoutArea.width * 0.80, layoutArea.height * 0.8);
                    this.layout.components[i].setVisible(visible);
                    this.layout.components[i].onResize(evt);
                    this.layout.components[i].onLayoutChange(evt);
                }
                
                //alert("values: top: " + layoutArea.top + ", left: " + layoutArea.left + ", width: " +  listWidth + ", height: " + layoutArea.height);
                if (this.favWindow) {
                    visible = this.favWindow.isVisible();
                    this.favWindow.setVisible(true);
                    if (leftRight) {
                        this.favWindow.setBounds(layoutArea.top, layoutArea.left, listWidth, layoutArea.height);
                    } else {
                        this.favWindow.setBounds(layoutArea.top, layoutArea.left + detailsWidth, listWidth, layoutArea.height);
                    }
                ...
                if (this.listingWin) {
                    ...
                    this.listingWin.setVisible(true);
                    if (leftRight) {
                        this.listingWin.setBounds(layoutArea.top, layoutArea.left, listWidth, layoutArea.height);
                    } else {
                        this.listingWin.setBounds(layoutArea.top, layoutArea.left + detailsWidth, listWidth, layoutArea.height);
                    }
                ...
                if (this.detailsWindow) {
                    visible = this.detailsWindow.isVisible();
                    this.detailsWindow.setVisible(true);
                    if (percent == 1) {
                        this.detailsWindow.setBounds(layoutArea.top, layoutArea.width - 600 - 40, 600, topHeight);
                    } else {
                        if (overlapped) {
                            if (leftRight) {
                                this.detailsWindow.setBounds(layoutArea.top, listWidth, detailsWidth, layoutArea.height);
                            } else {
                                this.detailsWindow.setBounds(layoutArea.top, layoutArea.left, detailsWidth, layoutArea.height);
                            }
                        } else {
                            if (leftRight) {
                                this.detailsWindow.setBounds(layoutArea.top, listWidth, detailsWidth, topHeight);
                            } else {
                                this.detailsWindow.setBounds(layoutArea.top, layoutArea.left, detailsWidth, topHeight);
                            }
                        }

                    }
                    this.detailsWindow.onResize(evt);
                    this.detailsWindow.onLayoutChange(evt);
                    this.detailsWindow.setVisible(visible);
                }
                if (this.photoWindow) {
                    visible = this.photoWindow.isVisible();
                    this.photoWindow.setVisible(true);
                    if (percent == 1) {
                        this.photoWindow.setBounds(layoutArea.top, layoutArea.left + layoutArea.width - 600 - 40, 600, bottomHeight);
                    } else {
                        if (overlapped) {
                            if (leftRight) {
                                this.photoWindow.setBounds(layoutArea.top, layoutArea.left + listWidth, detailsWidth, layoutArea.height);
                            } else {
                                this.photoWindow.setBounds(layoutArea.top, layoutArea.left, detailsWidth, layoutArea.height);
                            }
                        } else {
                            if (leftRight) {
                                this.photoWindow.setBounds(layoutArea.top, layoutArea.left + listWidth, detailsWidth, bottomHeight);
                            } else {
                                this.photoWindow.setBounds(layoutArea.top, layoutArea.left, detailsWidth, bottomHeight);
                            }
                        }
                    }
                    this.photoWindow.onResize(evt);
                    this.photoWindow.onLayoutChange(evt);
                    this.photoWindow.setVisible(visible);
                }
                if (this.layout) {
                    this.layout.enabled = true;
                }
            } catch (error) {
                alert("Failed to layout windows: " + error);
            }
        }
...
//                var pageSize = vyho.lib.Utilities.getPageSize(this.browserWin);
            ...
            try {
                ...
                if (responseText) {
                        ...
                        if (search != null) {
                            ...
                            if (entry != null) {
                                if (typeof this.searchResult == "undefined") {
                                    var parentNode = vyho.lib.Utilities.searchParent(link, "SECTION", {
                                        "class": "body"
                                    });
                                    if (parentNode != null) {
                    ...
                    */
                    ...
                    var srcs  = [];
                    try {
                        srcs = this.getEntryImages(details.responseText);
                    } catch (err) {
                        
                    }
                    if (srcs.length > 0) {
                        if (this.doShowGridViewImageIcons) {
                            var p = vyho.lib.Utilities.searchParent(link, "P", {
                                "class": "row"
                            });
                            if (p) {
        ...
        this.getEntryImages = function(text) {
            ...
            var str;
            var index;
            for (var i = 0; i < this.imageRegx.length; i++) {
                this.imageRegx[i].lastIndex = 0;
                
                res = this.imageRegx[i].exec(text);
                var counter = 0;
    ...
    */
        ...
        this.showImagePreview = function(evt, imgSource, data) {
            ...
            if (this.showImageWindow) {
                ...
                */
                ...
                //vyho.lib.Utilities.removeAllChildren(this.photoWindow.contentArea);
               
                var childNodes = new Array();
                childNodes.push.apply(childNodes, this.photoWindow.contentArea.childNodes);
                if (this.stickyMode || this.stickyMode == "true") {
                    this.layout.setEnabled(false);
                    if (this.stickyWindow != this.photoWindow) {
                        if (this.stickyWindow != null) {
                            this.stickyWindow.setVisible(false);
                        }
                    }
                    this.stickyWindow = this.photoWindow;
                    this.stickyWindow.setVisible(true);
                    
                    this.layout.setEnabled(true);
                } else {
                    this.photoWindow.setVisible(true);
                //this.photoWindow.setTransparent(1);
                }
                img = vyho.lib.Utilities.addNew("img", this.photoWindow.contentArea);
                img.setAttribute("style", "display: none;");
                img.setAttribute("id", "prevImageId");
                this.photoWindow.requestFocus();
                var me = this;
                img.addEventListener("load", function() {
                    vyho.lib.Utilities.removeNodes(me.photoWindow.contentArea, childNodes);
                    img.setAttribute("style", "display: block;");
                    me.setPreviewImageSize(me.photoWindow.contentArea.offsetWidth - 2 * me.photoWindow.padding,
                        me.photoWindow.contentArea.offsetHeight - 2 * me.photoWindow.padding);
                }, true);
        ...
        this.handleImageMouseOut = function(evt, imgSource, notused) {
            ...
            if (this.showImageWindow) {
                if (this.preferences.getImageMouseOut().getValue()) {
                    this.photoWindow.setVisible(false);
                //this.photoWindow.setTransparent(0.3);
                }
            }
        }
        ...
        this.replyTagRegex = [
        new RegExp("<span class\\=\\\"replylink\\\"><a id=\\\"replylink\\\" href=\"([\\s\\S]*?)\\\">reply</a>", "g"),
        new RegExp("<span class\\=\\\"replylink\\\"><a id=\\\"replylink\\\" href=\"([\\s\\S]*?)\\\">contact</a>", "g"),
        ...
        */
        ...
        this.handleDetailsMouseOut = function(evt, emailInfo, data) {
            ...
            //this.detailsWindow.setVisible(false);
            //this.detailsWindow.setTransparent(0.3);
        ...
        this.getPostDetailArea = function(postId, refNode) {
            var contentArea = this.detailsWindow.contentArea;
            vyho.lib.Utilities.removeAllChildren(contentArea);
            return contentArea;
        }
        ...
        this.showDetails = function(evt, emailInfo, data) {
            ...
            emailTemplateLink.addEventListener("click",
                vyho.lib.Utilities.runWith(this, this.showEmailTemplates, this.browserWin, ""), false);
            if (emailInfo != null) {
                emailLink.addEventListener("click",
                    vyho.lib.Utilities.runWith(this, this.showEmailEditor, emailInfo, new Array(postId, link, emailLink)), false);
            }
            var advInfo = {};
            advInfo.price = price;
        ...
        this.renderDetailArea = function(link, detailArea, detailText, location, advInfo, doc) {
            ...
            */
            if (this.stickyMode || this.stickyMode == "true") {
                this.layout.setEnabled(false);
                if (this.stickyWindow != this.detailsWindow) {
                    if (this.stickyWindow != null) {
                        this.stickyWindow.setVisible(false);
                    }
                }
                this.stickyWindow = this.detailsWindow;
                this.stickyWindow.setVisible(true);
                this.stickyWindow.requestFocus();
                this.layout.setEnabled(true);
            } else {
                this.detailsWindow.setVisible(true);
                //this.detailsWindow.setTransparent(1);
                this.detailsWindow.requestFocus();
            }
        }
        ...
        this.setStickyMode = function(evt, param1, commandDiv) {
            if (evt) {
                evt.preventDefault();
                evt.stopPropagation();
            }
            ...
            this.lastPreviewX  = this.photoWindow.getLeft();
            this.lastPreviewY = this.photoWindow.getTop();
            this.lastPostDetailX  = this.detailsWindow.getLeft();
            this.lastPostDetailY = this.detailsWindow.getTop();
        ...
        this.onStickyModeMouseClick = function(evt, param1, param2) {
            if (this.stickyMode || this.stickyMode == "true") {
                ...
                this.stickyWindow = null;
                this.stickyModeMouseMoveListener = null;
                this.photoWindow.setTop(this.lastPreviewY);
                this.photoWindow.setLeft(this.lastPreviewX);
                this.photoWindow.setVisible(true);
                this.detailsWindow.setTop(this.lastPostDetailY);
                this.detailsWindow.setLeft(this.lastPostDetailX);
                this.detailsWindow.setVisible(true);
                this.layout.doLayout();
            }
        }
        ...
        this.showPreference = function(evt, param1, commandDiv) {
            if (evt) {
                evt.preventDefault();
                evt.stopPropagation();
            }
        ...
        this.toggleScale = function(evt, param1, param2) {
            ...
            if (previewScaling) {
                prevImage.style.height = this.photoWindow.contentArea.clientHeight + "px";
                if (!this.preferences.getKeepAspectRatio().getValue()) {
                    prevImage.style.width = this.photoWindow.contentArea.clientWidth + "px";
                } else {
                    if (prevImage.offsetWidth > this.photoWindow.contentArea.clientWidth) {
        ...
        this.addBookmark = function(evt, auto, commandDiv) {
            try {
                if (evt) {
                    evt.preventDefault();
                    evt.stopPropagation();
        ...
        this.showBookmarkWindow = function(evt, param1, commandDiv) {
            try {
                if (evt) {
                    evt.preventDefault();
                    evt.stopPropagation();
        ...
        this.showFavorites = function(evt, param1, commandDiv) {
            try {
                if (evt) {
                    evt.preventDefault();
                    evt.stopPropagation();
    ...
    vyho.lib.apps.craigslist.Preferences = function() {
        ...
        */
        ...
        var roundCornerOptions = new Array();
        for (i = 1; i <= 15; i++) {
            roundCornerOptions[roundCornerOptions.length] = i + "px";
        }
        component = new vyho.lib.ui.Select("roundCornerRadius", "Round Corner Radius:", roundCornerOptions, null);
        var roundCornerRadius = this.prefList[this.prefList.length] = new vyho.lib.Preference(null, component, "10px");
        this.getRoundCornerRadius = function() {
    ...
    vyho.lib.net.EmailInfo = function(sourceUrl) {
        ...
        //<input class="anonemail" type="text" readonly="readonly" value="
        new RegExp("<input class\\=\\\"anonemail\\\".+? value=\\\"([\\s\\S]*?)\\\"></li>", "g"),
        new RegExp("<a href\\=\\\"mailto:([\\s\\S]*?)\\\"", "g")
        ];
        ...
        this.parseInfo2 = function(response, param1, param2) {
    ...
    vyho.lib.ui.layoutConfig.topOffset = 0;
    ...
    vyho.lib.ui.ScaleLayout = function(browserWin) {
        ...
        this.addComponent = function(component) {
            component.addLayoutChangeListener(new vyho.lib.ui.WindowLayoutListener(component.getId(), browserWin, this));
        ...
        * Return an array, 1st element is the width and 2nd is the height
        */
        this.getLayoutArea = function(browserWin) {
            ...
            return {
                width: width,
                height: height - vyho.lib.ui.layoutConfig.topOffset,
                top: vyho.lib.ui.layoutConfig.topOffset,
                left: 0
            };
        }
        ...
        this.doLayout = function() {
            ...
            var layoutArea = this.getLayoutArea(browserWin);
            ...
            for (var i = 0; i < this.components.length; i++) {
                ...
                var width = vyho.lib.Utilities.roundInt(layoutArea.width * widthRatio);
                var height = vyho.lib.Utilities.roundInt(layoutArea.height * heightRatio );
                var left = vyho.lib.Utilities.roundInt(layoutArea.width * leftRatio + layoutArea.left);
                var top = vyho.lib.Utilities.roundInt(layoutArea.height *  topRatio + layoutArea.top);
                
                if (width > layoutArea.width) {
                    width = layoutArea.width;
                }
                if (height > layoutArea.height) {
                ...
                //}
                this.components[i].setVisible(visible);
    ...
    vyho.lib.ui.MiniWin = function(id, width, height, title, parentWin, doc, browserWin, winManager,
        ...
        this.initialize = function(id, width, height, title, parentWin, doc, browserWin) {
            try {
                ...
                this.winHandle.style.borderRadius = options.cornerRadius;   //-moz-border-radius: 15px;
                this.winHandle.style.overflow = "hidden";
                ...
                this.titleBar.style.borderRadius = options.cornerRadius;
                this.titleBar.style.borderWidth = "0px";
                ...
                this.contentArea.style.borderRadius = options.cornerRadius;
        ...
        this.resizeSensor = function(x, y, top, left, width, height) {
            var cornerSize = 20;
            var widthSensitive = 1;
            var right = left + width - 1;
            var bottom = top + height - 1;
            //left

            if (x >= left && x <= left + this.borderWidth + widthSensitive) {
            ...
            //top
            if (y >= top && y < top + this.borderWidth + widthSensitive) {
            ...
            if (x <= right && x > right - this.borderWidth - widthSensitive) {
                if (y >= top && y < top + cornerSize) {
                    return "ne-resize";
                }
                if (y < bottom && y > bottom - cornerSize) {
            ...
            if (y <= bottom && y > bottom - this.borderWidth - widthSensitive) {
                if (x >= left && x < left + cornerSize) {
                    return "sw-resize";
                }
                if (x <= right && x > right - cornerSize) {
        ...
        this.onResizeAreaMouseMove = function(evt, param1, param2) {
            ...
            var layoutArea = this.layoutManager.getLayoutArea(this.browserWin);
            
            //var dim = this.getWindowSize();
            
            var maxWidth = layoutArea.width;
            var maxHeight = layoutArea.height;
    ...
    vyho.lib.ui.WindowLayoutListener = function(windowName, browserWin, layoutManager) {
        this.browserWin = browserWin;
        this.windowName = windowName;
        this.layoutManager = layoutManager;
        ...
        this.layoutChanged = function(winObj, evt) {
            try {
                ...
                var layoutArea = this.layoutManager.getLayoutArea(browserWin);
                //var dim = vyho.lib.Utilities.getWindowSize(this.browserWin);
                ...
                if (layoutArea.width <= 0) {
                    ...
                    widthRatio = width / layoutArea.width;
                    leftRatio = (left - layoutArea.left) / layoutArea.width;
                }
                ...
                if (layoutArea.height <= 0) {
                    ...
                    heightRatio = height / layoutArea.height;
                    topRatio = (top - layoutArea.top) / layoutArea.height;
                }

                //console.log(windowName + " : leftRatio is: " + leftRatio + 
                //    " , topRatio is: " + topRatio + " , widthRatio : " + widthRatio + " , heightRatio : " + heightRatio);
    ...
    vyho.lib.ui.WindowSizeChangeListener = function(windowName, browserWin, layoutManager) {
        this.browserWin = browserWin;
        this.windowName = windowName;
        this.layoutManager = layoutManager;
    ...
    */
    ...
    try {
        ...
        /*
        //mozilla plugin, need to merge the tree more gracefully
        if (typeof this.vyho !== "undefined") {
            for (var field in vyho.lib.apps) {
                //if (vyho.lib.apps.hasOwnProperty(field)) {
                    this.vyho.lib.apps[field] = vyho.lib.apps[field];
                //}
            }
        } else {
            this.vyho = vyho;
